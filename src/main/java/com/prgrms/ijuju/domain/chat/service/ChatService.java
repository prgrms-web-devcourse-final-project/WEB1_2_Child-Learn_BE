...
public class ChatService {
    ...
    public ChatRoom createChatRoom(Long memberId, Long friendId) {
        Member member = memberRepository.findById(memberId)
            .orElseThrow(() -> new CustomException(ChatException.USER_NOT_FOUND.getMessage()));
    ...
    public List<ChatMessageResponseDTO> getMessagesByChatRoomId(Long roomId, Long userId) {
        ...
        chatRoomRepository.findById(roomId)
            .orElseThrow(() -> new CustomException(ChatException.CHATROOM_NOT_FOUND.getMessage()));
    ...
    public void deleteChatRoom(Long roomId, Long userId) {
        ...
        if (!chatRoom.getMember().getId().equals(userId) && 
            ...
            throw new CustomException(ChatException.UNAUTHORIZED_CHATROOM_ACCESS.getMessage());
        }
    ...
    public void deleteMessage(Long messageId, Long userId) {
        Chat chat = chatRepository.findById(messageId)
            .orElseThrow(() -> new CustomException(ChatException.MESSAGE_NOT_FOUND.getMessage()));
            
        if (!chat.getSender().getId().equals(userId)) {
            throw new CustomException(ChatException.UNAUTHORIZED_MESSAGE_DELETION.getMessage());
        }
